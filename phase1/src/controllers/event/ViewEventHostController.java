...
public class ViewEventHostController extends RequestController{
    /**
     ...
     */
    public ViewEventHostController(DataMapper eventModel, IEventManager eventManager, DataMapper commentModel,
